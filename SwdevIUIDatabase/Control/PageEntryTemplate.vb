...
Public Class PageEntryTemplate
    ...
    Overridable Sub doInsertNewData()
        ...
        If Utils.exec_SP(PROCEDURE_MASTER, INSERT_PARAMETER) Then
            ...
            Utils.exec_SP("proc_zloguser", New Object() {"add", PROCEDURE_MASTER & "|add", kodeTransaksi, Session.vusername, -1})
        Else
    ...
    Overridable Sub doUpdateData()
        ...
        If Utils.exec_SP(PROCEDURE_MASTER, UPDATE_PARAMETER) Then
            ...
            Utils.exec_SP("proc_zloguser", New Object() {"add", PROCEDURE_MASTER & "|edit", UPDATE_PARAMETER(2), Session.vusername, -1})
        Else
